...
% is also necessary to use the geometry package to set the PDF to
% landscape size. Without it only the content is set in landscape mode
% but the PDF (white background) remains in default portrait size.
