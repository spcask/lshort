...
% In addition to using the a5paper option with the document class, it is
% also necessary to use the geometry package to set the PDF to the same
% size. Without it only the content is set in a5paper size but the PDF
% (white background) remains in default size.
