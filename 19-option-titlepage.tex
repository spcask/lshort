% The article class does not start a new page by default, while report
% and book do. The titlepage option is used to specify that a new page
% should be started after the document title.
